...
public class CreateBookSuggestionAdapter(ChatClient chatClient, ISearchBooksChatTool searchBooksChatTool, ISearchAuthorsChatTool searchAuthorsChatTool, ISingleUserPromptChatCompletion singleUserPromptChatCompletion) : ICreateBookSuggestionPort
{
