...
public class AddConnectionIdRequestHandler(HubConnection connection): DelegatingHandlerBase, IAddConnectionIdRequestHandler
{
    public const string ConnectionIdHeaderName = "X-LocalTools-ConnectionId";

    protected override Task<HttpRequestMessage> HandleRequest(HttpRequestMessage request, CancellationToken cancellationToken)
    {
